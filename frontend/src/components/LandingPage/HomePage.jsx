  ...
  return (
    ...
    <div className="min-h-screen flex flex-col font-sans text-[#3E362E]">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-6 right-6 bg-[#25D366] text-white p-3 rounded-full shadow-[4px_4px_0px_0px_rgba(62,54,46,0.2)] z-50 hover:scale-110 transition-transform flex items-center justify-center border-4 border-white"
        title="Chat WhatsApp">
